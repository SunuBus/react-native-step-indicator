        ...
        return (
          <TouchableWithoutFeedback style={styles.stepLabelItem} key={index} onPress={() => this.stepPressed(index)}>
            <View style={styles.stepLabelItem}>
              <Text numberOfLines={this.state.customStyles.labelNumberOfLines} style={[styles.stepLabel,selectedStepLabelStyle , { fontSize: this.state.customStyles.labelSize, textAlign: this.state.customStyles.labelTextAlign }]}>
                {label}
              </Text>
            </View>
          </TouchableWithoutFeedback>
